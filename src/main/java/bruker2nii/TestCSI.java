...
public class TestCSI {
    public static void main(String[] args) {
        Bruker2nii bruker2nii = new Bruker2nii("D:\\DATA SETs\\20210121_085814_21012021_1mixedPhantom_CSI_PRESS_21012021_1_1_1\\rare\\pdata\\1\\2dseq");
        bruker2nii.convert("rare.nii.gz", DataType.MRSI);
